...
SL.Model = class {
    ...
    reset(params) {
        ...
        const p = this.params;
        this.state = {
            phi: (p.phi0 != null) ? p.phi0 : 0,
            alpha: (p.alpha0 != null) ? p.alpha0 : 0.1 * Math.PI / 180,
            theta: (p.theta0 != null) ? p.theta0 : 0.1 * Math.PI / 180,
            phiDot: (p.phiDot0 != null) ? p.phiDot0 : 0,
            alphaDot: (p.alphaDot0 != null) ? p.alphaDot0 : 0,
            thetaDot: (p.thetaDot0 != null) ? p.thetaDot0 : 0,
            time: 0
        };
        this.tau = 0;
    }
