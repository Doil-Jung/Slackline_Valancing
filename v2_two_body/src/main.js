/**
 * Slackline Balance Simulator — Main Entry Point
 * 
...
(function () {
    ...
    function init() {
        ...
        console.log('Slackline Balance Simulator initialized');
    }
    ...
    function setupButtons() {
        ...
        document.getElementById('btn-reset').addEventListener('click', () => {
            stop();
            SL.Params.theta0 = parseFloat(document.getElementById('slider-theta0').value);
